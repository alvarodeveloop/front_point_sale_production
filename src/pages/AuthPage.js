...
const AuthPage = (props) => {
  ...
  if (imgDisplay) {
    imgLogin = (
      <img
        src={require("../assets/img/login/login5.jpg")}
        className="img-login"
      />
    );
  } else {
    ...
    <Container>
      <Row>
        <Col xs={12} sm={6} md={6} lg={6}>
          <div className="containerImg">{imgLogin}</div>
        </Col>
        <Col
          xs={12}
          sm={{
              ...
              <Form onSubmit={onSubmit} noValidate validated={validated}>
                ...
                <Row>
                  <Col xs={12} sm={12} md={12} lg={12}>
                    <Button size="sm" variant="info" type="submit" block={true}>
                      Enviar
                    </Button>
                  </Col>
                </Row>
                    ...
                    <FacebookLogin
                      ...
                      render={(renderProps) => (
                        <Button
                          ...
                          disabled={renderProps.disabled}
                        >
                          <FaFacebook /> Ingresa con Facebook
                        </Button>
                      )}
