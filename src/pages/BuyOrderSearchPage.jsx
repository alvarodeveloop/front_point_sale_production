    ...
    <Container fluid>
      <Row>
        ...
        <Col className="text-center title_principal">
          <h4>Total Ordenes Realizadas <Badge variant="danger" className="font-badge d-inline d-md-none">{globalState.cotizacionData.length}</Badge></h4>
        </Col>
      </Row>
      <Row>
        <Col sm={6} md={3} lg={3} xs={6} className="text-center">
          <Button block={true} variant="success" onClick={goToForm} size="sm">
            <span className="d-none d-md-inline">Nueva </span> Orden de Compra <FaPlusCircle />
          </Button>
        </Col>
        <Col sm={6} md={3} lg={3} xs={6} className="text-center">
          <Button
