    ...
    <Styles>
      <Row className="justify-content-center">
        <Col sm={5} md={5} lg={5} className="text-center">
          <Button size="sm" variant="danger" block={true} onClick={addPayment}>
            Agregar pago a la boleta <FaPlusCircle />
          </Button>
        </Col>
      </Row>
      <br />
      ...
      <Row className="justify-content-center">
        <Col sm={6} xs={6} md={4} lg={4}>
          <Button
            ...
            block={true}
            type="button"
            onClick={() => props.changeSection(5, false)}
            variant="secondary"
          >
            Atrás
          </Button>
        ...
        <Col sm={6} xs={6} md={4} lg={4}>
          <Button
            ...
            block={true}
            type="button"
            onClick={() => props.changeSection(7, true)}
            variant="secondary"
          >
            siguiente
          </Button>
