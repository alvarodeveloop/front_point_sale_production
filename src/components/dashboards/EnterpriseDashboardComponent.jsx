...
const EnterpriseDashboardComponent = (props) => {
  ...
  const handleStadistics = () => {
    ...
    dataDh.totalPayments.forEach((v, i) => {
      ...
      data_donut_payments.datasets[0].hoverBackgroundColor.push(
        ARRAY_COLORS[i]
      );
    });
  ...
  const fetchData = () => {
    axios
      .get(API_URL + "dashboard_stadistics")
      .then((result) => {
        ...
        <Row className="animate__animated animate__fadeInUp">
          <Col sm={12} md={12} lg={12}>
                        ...
                        <Row>
                          ...
                          <Col sm={3} md={3} lg={3}>
                            <Button
                              ...
                              type="button"
                              onClick={() =>
                                routerFunction("/invoice/invoice_search")
                              }
                            >
                              Facturaciones
                            </Button>
                          ...
                          <Col sm={3} md={3} lg={3}>
                            <Button
                              ...
                              type="button"
                              onClick={() =>
                                routerFunction("/sale_note/sale_note_search")
                              }
                            >
                              Notas de Venta
                            </Button>
                          ...
                          <Col sm={3} md={3} lg={3}>
                            <Button
                              ...
                              type="button"
                              onClick={() =>
                                routerFunction("/src/bill/bill_search")
                              }
                            >
                              Boletas
                            </Button>
                        ...
                        <Row>
                          <Col sm={3} md={3} lg={3}>
                            <Button
                              ...
                              type="button"
                              onClick={() =>
                                routerFunction("/guide/guide_search")
                              }
                            >
                              Guias de Despacho
                            </Button>
            ...
            <Row className="animate__animated animate__fadeInLeft justify-content-center d-none d-md-flex">
              ...
              />
              <CardStatusComponent
                value={dataDh.cardStadistics.total_invoice}
                styleInline={"lnr lnr-book"}
                colorFont={"warning"}
                title={"Facturacion"}
              />
              <CardStatusComponent
                value={dataDh.cardStadistics.total_sale_note}
                styleInline={"lnr lnr-book"}
                colorFont={"danger"}
                title={"Notas de Ventas"}
              />
              <CardStatusComponent
                value={dataDh.cardStadistics.total_bill}
                styleInline={"lnr lnr-book"}
                colorFont={"primary"}
                title={"Boletas"}
              />
              <CardStatusComponent
                value={dataDh.cardStadistics.total_guide}
                styleInline={"lnr lnr-book"}
                colorFont={"dark"}
                title={"Guias"}
              />
